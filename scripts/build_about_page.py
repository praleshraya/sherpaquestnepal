...
<meta name="theme-color" content="#0b0b0d"><meta name="description" content="Get to know Sherpa Quest Nepal, a Nepal-based destination for motorcycle riding gear, helmets, luggage and off-road accessories.">
...
<link rel="stylesheet" href="styles.css?v=3"><link rel="stylesheet" href="about.css?v=3"><link rel="stylesheet" href="theme.css?v=2"><script defer src="navigation.js?v=3"></script><script defer src="floating-promo.js"></script></head>
...
<main id="main">
  ...
  <section class="about-categories"><div class="shell"><p class="eyebrow">WHAT YOU WILL FIND</p><h2>READY FOR YOUR<br><em>NEXT ROUTE.</em></h2><div class="about-category-grid"><a href="index.html?category=Helmets#products">HELMETS</a><a href="index.html?category=Riding%20jackets#products">RIDING JACKETS</a><a href="index.html?category=Gloves#products">GLOVES</a><a href="index.html?category=Boots#products">BOOTS</a><a href="index.html?category=Luggage%20%26%20bags#products">LUGGAGE &amp; BAGPACKS</a><a href="index.html?category=Rainwear#products">RAINWEAR</a></div></div></section>
  <section class="about-connection shell"><div><p class="eyebrow">RIDE WITH US</p><h2>LET'S FIND<br><em>YOUR GEAR.</em></h2><p>Have a question about a product, size, or availability? Get in touch with Sherpa Quest Nepal.</p></div><div class="about-contact-links"><a href="tel:+9779744464587"><small>CALL US</small><strong>+977 974-4464587</strong></a><a href="mailto:sherpaquestoffroad@gmail.com"><small>EMAIL US</small><strong>sherpaquestoffroad@gmail.com</strong></a><a href="https://wa.me/9779744464587" target="_blank" rel="noopener"><small>MESSAGE US</small><strong>WhatsApp Sherpa Quest Nepal</strong></a></div></section>
</main>{footer}
